...
const closePeerConnectionAndResetState = () => {
  ...
  if(connectedUserDetails.callType == constants.callType.VIDEO_PERSONAL_CODE || connectedUserDetails.callType == constants.callType.VIDEO_STRANGER){
    ...
    console.log("in if of closepeeer")
...
const checkCallPossibility = (callType) => {
  ...
  if((callType === constants.callState.VIDEO_PERSONAL_CODE || callType === constants.callState.VIDEO_STRANGER) && (callState === constants.callState.CALL_AVAILABLE_ONLY_CHAT)) {
    return false
  }
